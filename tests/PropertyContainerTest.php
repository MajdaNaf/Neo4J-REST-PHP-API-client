...
class PropertyContainerTest extends Neo4jRestTestCase
{
    public function setUp() {
        parent::setUp();
        $this->propCont = new Neo4jRest\PropertyContainer();
    }
    
    public function test__Set() {
        
        $propCont = $this->propCont;
        $propVal = 'testing';
        $prop = 'newProp';
    ...
    public function testGetProperties() {
        ...
        $this->assertEmpty($data, 'New PropertyContainer should produce ' .
            'empty result from getProperties().');
